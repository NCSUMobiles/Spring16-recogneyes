...
#ifndef _Included_com_istudy_helper_filters_NativeFilterFunc
#define _Included_com_istudy_helper__filters_NativeFilterFunc
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: ([IIID)[I
 */
//JNIEXPORT jintArray JNICALL Java_com_istudy_helper_NativeFilterFunc_discreteGaussianBlur
//  (JNIEnv *, jclass, jintArray, jint, jint, jdouble);
//
///*
// * Class:     cn_Ragnarok_NativeFilterFunc
 ...
 * Signature: ([IIII)[I
 */
JNIEXPORT jintArray JNICALL Java_com_istudy_helper_filters_NativeFilterFunc_pxelateFilter
  (JNIEnv *, jclass, jintArray, jint, jint, jint);
