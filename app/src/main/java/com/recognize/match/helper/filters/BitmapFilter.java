...
/**
 * This has a lot of useful filters. The only used currently is pixelate. Hence, the other filters
...
//			if (options.length < 1) {
//				return com.istudy.helper.GaussianBlurFilter.changeToGaussianBlur(bitmap, 1.2);
//			}
//			return com.istudy.helper.GaussianBlurFilter.changeToGaussianBlur(bitmap, (Double) options[0]); // sigma
//		}
